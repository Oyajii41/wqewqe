...
class SendSms():
    ...
    def Derimod(self):
        try:
            ...
            json = {"add_loyalty": False, "confirm" : True, "date_of_birth": "1991-05-15","email":{self.mail},"email_allowed":False,"event_type": "register","first_name":"Memati","gender":"male","last_name":"Baş","phone":{self.phone},"resend":False,"sms_allowed":False,"user_type":"registered"}
            r = requests.post(url, json=json)
            if r.status_code == 202:
